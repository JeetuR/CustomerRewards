...
public class ControllerIntegrationTests {
	...
	public void validCustomerWithRewards() throws Exception {
		...
		ResponseEntity<?> responseEntity = this.testRestTemplate.getForEntity(
				"http://localhost:" + port + "/store/customer/getRewardsPoints/" + customer, RewardsInfo.class);
	...
	public void nonExistantCustomer() throws Exception {
		...
		ResponseEntity<?> responseEntity = this.testRestTemplate.getForEntity(
				"http://localhost:" + port + "/store/customer/getRewardsPoints/" + customer, String.class);
	 ...
	 * ). Amount in one month less than qualified month. Amount in another month >
	 * than qualified month.
	 */
	@Test
