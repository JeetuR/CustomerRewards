...
public class ServiceMockTests {
	...
	public void getRewardsForValidCustomer() {
		...
		Double rewards = mockRewardsService.computeRewardsFor(custID);
	...
	public void lookupInvalidCustomer() {
		...
		RewardsException rexp = assertThrows(RewardsException.class, () -> mockRewardsService.computeRewardsFor(invalidCustID), "Given Customer ID Not Found");
